...
int bleTries = 0;
  ...
  bool windDataEqual(wind_data_t w1, wind_data_t w2)
  {
    ...
    return w1.windSpeed == w2.windSpeed && w1.windDirection == w2.windDirection && w1.batteryLevel == w2.batteryLevel && w1.temperature == w2.temperature && w1.roll == w2.roll && w1.pitch == w2.pitch && w1.compass == w2.compass && w1.apparentWindSpeed == w2.apparentWindSpeed && w1.apparentWindDirection == w2.apparentWindDirection;
  }
  ...
  class MyClientCallback : public BLEClientCallbacks
  {
    ...
    void onDisconnect(BLEClient *pclient)
    {
      ...
      if (DEBUG_1)
      {
        Serial.println("Disconnected from Wind Meter");
      }
    }
  };
  ...
  static void printWindData()
  {
    ...
    Serial.println(" m/s * 100");
    Serial.print("Wind Direction: ");
    Serial.print(windData.windDirection);
    Serial.println("º");
    Serial.print("Battery Level: ");
    Serial.print(windData.batteryLevel);
    Serial.println("%");
    Serial.print("Temperature: ");
    Serial.print(windData.temperature);
    Serial.println("ºC");
    Serial.print("Roll: ");
    Serial.print(windData.roll);
    Serial.println("º");
    Serial.print("Pitch: ");
    Serial.print(windData.pitch);
    Serial.println("º");
    Serial.print("Compass: ");
    Serial.print(windData.compass);
    Serial.println("º");
  ...
  static void printApparentData()
  {
    ...
    Serial.print(windData.apparentWindSpeed);
    Serial.println(" m/s * 100");
    Serial.print("Apparent Wind Direction: ");
    Serial.print(windData.apparentWindDirection);
    Serial.println("º");
    Serial.println("-------------------------------------------------------------");
  }
  ...
  void printDeviceData()
  {
    ...
    Serial.println(deviceInfo.manufacturer);
    Serial.print("Model Number : ");
    Serial.println(deviceInfo.modelNumber);
    Serial.print("Serial Number : ");
    Serial.println(deviceInfo.serialNumber);
    Serial.print("Hardware Revision : ");
    Serial.println(deviceInfo.hardwareRevision);
    Serial.print("Firmware Revision : ");
    Serial.println(deviceInfo.firmwareRevision);
